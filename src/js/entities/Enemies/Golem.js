...
import { GolemMovementControllerComponent } from "../../components/GolemMovementController.js";
 ...
 */
export class Golem extends BillBoard {
    /**
    ...
    constructor(scene, x, y, id, config) {
        ...
        console.log("Created Golem Enemy:", this.id);
    ...
    addComponents() {
        ...
        const controller = new GolemMovementControllerComponent(this, getCustomTiledProperty(this.config, "state"), this.config.patrolRoute);
