...
import { SlimeMovementControllerComponent } from "../../components/SlimeMovementController.js";
...
/**
 * Slime - Hit-and-run nuisance enemy with high mobility.
 *
 * @class
 * @category Entities
 * @extends BillBoard
 ...
 */
export class Slime extends BillBoard {
    /**
    ...
    addComponents() {
        ...
        const controller = new SlimeMovementControllerComponent(this, getCustomTiledProperty(this.config, "state"), this.config.patrolRoute);
